...
HERE = Path(tempfile.gettempdir()) / "tero-landing-v2-es"
...
SCENES: list[Scene] = [
    Scene(
        "s1_hero",
        "Inicio",
        "tero · agente docente conversacional",
        [
            Sent(
                "tero: el agente docente conversacional para la sala de clases chilena.",
                "tero · el agente docente conversacional para la sala chilena",
            ),
            Sent(
                "La fotocopia de la clase de mañana, armada desde tu propia carpeta. El agente propone; el profesor decide.",
                "la fotocopia de mañana, desde tu carpeta · el agente propone, el profesor decide",
            ),
        ],
        lead=0.7,
        tail=0.8,
    ...
    Scene(
        "s2_priv",
        "Privacidad",
        "tu carpeta · la única fuente de verdad",
        [
            Sent(
                "Tu carpeta es la única fuente de verdad: el cuento que leíste, el objetivo marcado, el vocabulario de la semana.",
                "Tu carpeta es la única fuente de verdad",
            ),
            Sent(
                "Y bajo la Ley 21.719, los datos de tus estudiantes jamás viajan a la nube.",
                "Ley 21.719: los datos nunca tocan la nube",
            ),
            Sent(
                "Todo queda en tu equipo, y nada se escribe sin tu aprobación explícita.",
    ...
    Scene(
        "s3_arch",
        "Arquitectura",
        "Grafo Multi-Agente Strands sobre Amazon Bedrock",
        [
            Sent(
                "Bajo el capó, tero orquesta un Grafo Multi-Agente con Strands Agents sobre Amazon Bedrock.",
                "Grafo Multi-Agente · Strands Agents · Amazon Bedrock",
            ),
            Sent(
                "Un redactor pedagógico prepara el material, y un auditor de calidad revisa el apego al currículum.",
                "Redactor pedagógico + auditor de calidad curricular",
            ),
            Sent(
                "Nova Lite, GLM 4.7 Flash y MiniMax M2.5 hacen la inferencia, con cada turno trazado en OpenTelemetry.",
                "Model Trio + trazas OpenTelemetry en cada turno",
            ),
            Sent(
                "Cero herramientas de escritura para el modelo: la carpeta nunca sale del equipo.",
                "Cero herramientas de escritura · la carpeta nunca sale",
            ),
        ],
    ),
    Scene(
        ...
        [
            Sent(
                "Escribe en español natural y pregunta qué tienes en la carpeta.",
                "Pregunta en español natural, sin menús",
            ),
            Sent(
                "tero responde con exactitud: cinco fuentes, citadas una por una. Y no escribe ningún archivo.",
                "Responde con exactitud · no escribe ningún archivo",
            ),
        ],
        lead=1.0,
    ),
    Scene(
        "s5_intent_b",
        "Intención B",
        "crear material con citas verificadas",
        [
            Sent(
                "Pídele una evaluación de comprensión lectora para cuarto básico.",
                "«Prepara una evaluación de comprensión lectora para 4° básico»",
            ),
            Sent(
                "tero conversa los detalles y arma la propuesta en memoria: resumen, vista previa y citas verificadas contra tus archivos.",
                "Propuesta en memoria · citas verificadas contra tus fuentes",
            ),
            Sent("Los avisos informan; nunca bloquean.", "Los avisos informan · nunca bloquean"),
        ],
        lead=1.0,
    ),
    Scene(
        "s6_gate",
        "Compuerta",
        "aprueba y nace la fotocopia",
        [
            Sent(
                "Nada toca el disco hasta que apruebas: con ye, o simplemente escribiendo dale.",
                "Apruebas con [y] o diciendo «dale» · nada se escribe antes",
            ),
            Sent(
                "El host escribe en derivados y compila a LaTeX: la fotocopia queda lista para mañana.",
                "El host escribe en derivados/ y compila a LaTeX",
            ),
        ],
        lead=1.0,
    ),
    Scene(
        "s6b_seal",
        "Sello docente",
        "firma criptográfica · proof of pedagogical agency",
        [
            Sent(
                "Aquí está lo que un chatbot no tiene: cada material aprobado sale con un sello criptográfico a nombre del profesor.",
                "cada material, sellado criptográficamente a tu nombre",
            ),
            Sent(
                "El sello une el hash de tus fuentes, el del derivado, el modelo y la traza completa: criterio humano aprobado en el ledger local.",
                "hash de fuentes + derivado + modelo + traza · .tero/decisiones/",
            ),
            Sent(
                "verify-seal comprueba la integridad en segundos: esto lo aprobó una docente, con sus fuentes, y nadie lo alteró.",
                "verify-seal · integridad verificada en segundos",
            ),
        ],
        lead=1.0,
    ),
    Scene(
        "s7_nee",
        "Intención C",
        "adaptación NEE · Decreto 83",
        [
            Sent(
                "Para un estudiante con dislexia, pide la adaptación.",
                "«Adapta la evaluación del cóndor para un estudiante con dislexia»",
            ),
            Sent(
                "tero aplica el Decreto 83: primero apoyos de acceso, tiempo extendido y enunciados en dos pasos; después los objetivos.",
                "Decreto 83: primero apoyos de acceso, después los objetivos",
            ),
            Sent(
                "Entrega una versión nueva con origen trazable. El original queda intacto, verificado por hash.",
                "Versión nueva con origen · el original queda intacto",
            ),
        ],
        lead=1.0,
    ),
    Scene(
        "s8_trio",
        "Amazon Bedrock",
        "trío de modelos en vivo · tero-offline honesto",
        [
            Sent(
                "El diagnóstico en vivo valida el trío de modelos de Bedrock.",
                "check-aws en vivo · Amazon Bedrock Model Trio",
            ),
            Sent(
                "Nova Lite, rápido y económico; GLM 4.7 Flash, estricto con los esquemas NEE; y MiniMax, con rúbricas completas.",
                "Nova Lite · GLM 4.7 Flash · MiniMax M2.5",
            ),
            Sent(
                "¿Y sin internet? tero-offline: un modelo Strands real, reproducible, sin fingir llamadas a la nube.",
                "tero-offline: Strands real, sin fingir llamadas a la nube",
            ),
        ],
    ),
    Scene(
        ...
        [
            Sent(
                "tero devuelve la tarde del domingo a quien enseña.",
                "tero devuelve la tarde del domingo a quien enseña",
            ),
            Sent(
                "Y cada material queda firmado a tu nombre.", "cada material, firmado a tu nombre"
            ),
            Sent(
                "Código abierto, licencia MIT, para la Hackathon Agents for Humans de AWS.",
                "MIT · código abierto · Hackathon Agents for Humans de AWS",
            ),
            Sent("Tu aula, tus fuentes, tu criterio.", "tero · tu aula, tus fuentes, tu criterio"),
        ],
    ),
]
...
def top_bar(draw: ImageDraw.ImageDraw, scene: Scene, chapter_idx: int):
    ...
    ctext(draw, (100, 22), "·  agente docente conversacional", fill=MUT, font=F(16))
    f_badge = F(14, True)
    x = W - 36
    for label, col in (
        ("OpenTUI", (188, 140, 255)),
...
# ---- S1 hero ---------------------------------------------------------------
BADGES_S1 = [
    ("Sello criptográfico docente", ACC),
...
def render_s1(t, sc, tl):
    ...
    ctext(d, (130, 448 + bob * 0.3), "Vanellus chilensis · queltehue", fill=MUT, font=F(19))
    if t > 0.35:
        d.text((126, 500), "tero", fill=ACC, font=F(104, True))
    if t > 0.75:
        d.text((130, 638), "tus fuentes, tu criterio", fill=TXT, font=F(36, True))
        ctext(d, (130, 696), "El tero avisa. Tú decides.", fill=MUT, font=F(23))
...
PRIN = [
    (
        "1 · TU CARPETA",
        "El cuento que leíste, el OA marcado, el vocabulario de la semana: la única fuente de verdad.",
        ACC,
    ),
    (
        "2 · LEY 21.719",
        "Notas, salud y asistencia nunca viajan a la nube: quedan en tu equipo, siempre.",
        OK,
    ),
    (
        "3 · TU APROBACIÓN",
        "El agente propone en memoria. Nada se escribe sin tu «y» o tu «dale».",
        WARN,
    ),
]
...
def render_s6(t, sc, tl):
    ...
    if aa > 0:
        ...
        ctext(
            ...
            "fotocopia lista · LaTeX · sello al pie",
            fill=WARN,
            font=F(23, True),
            anchor="ma",
        )
...
def render_s9(t, sc, tl):
    ...
    f_m = F(44, True)
    ctext(d, (W // 2, 512), "tu aula, tus fuentes, tu criterio", fill=TXT, font=f_m, anchor="ma")
    if t > 1.2:
    ...
    if t > 2.4:
        chips = [
            ("MIT", OK),
            ("sello docente criptográfico", ACC),
...
def render_s6b(t, sc, tl):
    ...
    if a > 0:
        ...
        ctext(
            ...
            "el pie del material lleva el sello",
            fill=MUT,
            font=F(21),
            anchor="ma",
        )
...
def write_subs(tl: Timeline):
    ...
    (OUT_DIR / "tero-demo-es.srt").write_text("\n".join(srt), encoding="utf-8")
    (OUT_DIR / "tero-demo-es.vtt").write_text("\n".join(vtt), encoding="utf-8")
...
def main():
    ...
    write_subs(tl)
    print("== render ==")
    render_video(tl, loud, OUT_DIR / "tero-demo-es.mp4")
    print("== qc ==")
    r = subprocess.run(
        [
            "ffprobe",
